...
const manifest = {
    ...
    version: "1.0.0",
    name: "Biblioteca de jfuster",
    description: "Biblioteca de películas y cortometrajes de jfuster",
    ...
    // Permite instalar con configuración opcional (clave de Real-Debrid)
    // vía /configure -> genera una URL tipo /rd=CLAVE/manifest.json
    behaviorHints: {
        configurable: true,
